    ...
    return (
        <nav className="p-4 flex flex-col h-full">
            <ul className="space-y-2 flex-grow">
                ...
                <li className="px-3 py-2 text-xs font-semibold text-muted-foreground uppercase">Account</li>
                {navItems.map((item) => (
                     <li key={item.href}>
                        <Link 
                            href={item.href} 
                ...
                <div className="flex-1 flex flex-col">
                    <header className="flex h-16 items-center gap-4 border-b bg-card px-6 lg:hidden">
                        ...
                        <div className="flex-1">
                            <h1 className="font-semibold text-xl text-primary">RAJ CARGO - ACCOUNTS</h1>
                        </div>
                    </header>
