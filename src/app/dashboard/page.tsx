...
import { ArrowRight, BookCopy, Cpu } from 'lucide-react';
       ...
       <div className="grid md:grid-cols-2 gap-8 max-w-4xl w-full">
            <Card className="hover:shadow-lg transition-shadow">
             ...
             <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                    <p>Tools for incoming package scanning, sorting by destination, and managing outbound line haul trucks. (Features coming soon)</p>
                </CardContent>
                <CardContent>
                     <Link href="/hub">
                        <Button className="w-full">
