...
import { Home, BookCopy, PlusCircle, ScanLine, Menu, Settings, Settings2, Truck, Cpu, LayoutDashboard, IndianRupee, LogOut } from 'lucide-react';
    ...
    return (
        <nav className="p-4 flex flex-col h-full">
            <ul className="space-y-2 flex-grow">
                ...
                <li className="px-3 py-2 text-xs font-semibold text-muted-foreground uppercase">Operations</li>
                <li>
