...
import { Truck, CheckCircle, BookCopy, PlusCircle, ScanLine, Settings2, ArrowRight } from 'lucide-react';
import { cn } from '@/lib/utils';
import { format } from 'date-fns';

const bookingLinks = [
    {
        href: '/booking/waybills/create',
        title: 'Create Waybill',
        description: 'Start a new shipment and generate a waybill.',
        icon: PlusCircle,
        iconBgColor: 'bg-green-100 dark:bg-green-900/50',
        iconColor: 'text-green-600 dark:text-green-300'
    },
    {
        href: '/booking/waybills',
        title: 'Waybill Book',
        description: 'View, manage, and track all your waybills.',
        icon: BookCopy,
        iconBgColor: 'bg-sky-100 dark:bg-sky-900/50',
        iconColor: 'text-sky-600 dark:text-sky-300'
    },
    {
        href: '/booking/manifest',
        title: 'Dispatch Manifests',
        description: 'Group waybills into a manifest for dispatch.',
        icon: Truck,
        iconBgColor: 'bg-amber-100 dark:bg-amber-900/50',
        iconColor: 'text-amber-600 dark:text-amber-300'
    },
    {
        href: '/booking/delivered',
        title: 'Delivered Waybills',
        description: 'View a record of all completed shipments.',
        icon: CheckCircle,
        iconBgColor: 'bg-blue-100 dark:bg-blue-900/50',
        iconColor: 'text-blue-600 dark:text-blue-300'
    },
    {
        href: '/booking/print-sticker',
        title: 'Print Sticker',
        description: 'Print individual or bulk waybill stickers.',
        icon: ScanLine,
        iconBgColor: 'bg-rose-100 dark:bg-rose-900/50',
        iconColor: 'text-rose-600 dark:text-rose-300'
    },
    {
        href: '/booking/configuration',
        title: 'Configuration',
        description: 'Set default sender information for new waybills.',
        icon: Settings2,
    ...
    <div className="space-y-8">
       <div className="p-8 rounded-xl bg-card border relative overflow-hidden">
        ...
        <div className="relative">
            ...
            <p className="text-muted-foreground mt-2 text-lg">Your central hub for all booking operations on {format(new Date(), 'PPP')}.</p>
        </div>
      </div>
