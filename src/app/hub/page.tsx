...
export default function HubDashboardPage() {
    ...
    return (
        <div className="space-y-8">
            <div className="p-6 rounded-xl bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/50 dark:to-indigo-900/80 border border-purple-200 dark:border-purple-800 shadow-md">
                <h1 className="text-3xl font-bold text-purple-800 dark:text-purple-100">Hub Dashboard</h1>
                <p className="text-purple-600 dark:text-purple-300 mt-1">Verify incoming shipments and manage outbound dispatch.</p>
            </div>
